              ...
              md:justify-start text-center gap-y-8 flex-1 px-6 pb-10">
                ...
                <div className="w-full px-56 flex-col">
                    ...
                    <div className="grid grid-flow-col items-center justify-center">
                        {/* 수정이 필요한 부분 시작점 db에 팀원들 정보등을 넣고 map으로 돌려서 줄을 줄여야함 grid도 css에서 건드려서 div에 className 새로줘야함*/}
                        <div className="mt-20 max-h-screen relative bg-white shadow-lg w-60 h-96 border-2 border-gray-500 flex items-center  flex-col hover:bg-blue-600 hover:text-white rounded-lg">
                            ...
                            <div className="mt-16 flex items-center flex-col justify-center">
                                <h1 className="font-bold text-2xl mt-4">사람1</h1>
                                <p className="font-semibold text-xl text-gray-500">풀스택 개발</p>
                                <p className="text-center mt-4">팀원 소개 테스트 문구입니다. 전반적인 개발의 진행상황을 보고합니다. 테스트문구 테스트문구</p>
                            </div>
